...
class PdnController extends Controller {
	...
	public function pdnUpload($id)
	{
        ...
        return redirect("/product/pdn/$id");
...
/* comparedArray create */
  ...
  /* close comparedArray */
      ...
      return view("product.pdn_verify",compact('validate_array','devConfigArray','comparedArray','upload'));
	}
	...
	/*
	* function pdnAfterUpload
	* redirected to this after varifying upload to change status 
	*  
	*/		
	public function pdnAfterUpload($id)
  	{
