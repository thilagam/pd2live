							...
							<ul class="list-unstyled mailbox-list">
								<li @if(strcmp($folder,"inbox") == 0) class="active" @endif>
									<a href="{{ url('mailbox') }}">
										...
										<span class="badge badge-success pull-right"> @if($unread_count > 0) {{ $unread_count }}  @endif</span>
									</a>
								</li>
